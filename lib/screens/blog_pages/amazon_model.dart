          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text('Posted on February 28, 2019 / '),
                  Icon(Icons.comment),
                  GestureDetector(
                      onTap: () {},
            ...
            Container(
              width: MediaQuery.of(context).size.width * 0.95,
              child: Text("  I have run into people asking me frequently about how to perfectly conduct business over Amazon keeping to good revenue. I have been into this business for quite a while now for which I even boast to rack up to 80k of pure turnover, but trust me, even I cannot present the ideal selling criteria. But on the other hand, guess what, you need to bring yourself closer to the ideal, "
            ...
            Container(
              width: MediaQuery.of(context).size.width * 0.95,
              child: Text("  The thing is, with whatever guide you come across, thorough research is the best way to go. A good guide will only show you the way or leave you the hassle to pick out where exactly to start from. "
            ...
            Container(
              width: MediaQuery.of(context).size.width * 0.95,
              child: Text("  By now, many of you will be already scratching their heads begging to end the chit chat and get down to business. Well, hold onto your horses while I pen down some key points to loosen up the talk. Low-key vendors are "
            ...
            Container(
              width: MediaQuery.of(context).size.width * 0.95,
              child: Text("  Make sure you do your homework before listing items and clogging your inventory with useless listings that do nothing but hold your otherwise smooth sales. Well in case you do have a “clogged” inventory, it won’t hurt in the testing phase. A simple hit and trail will benefit you greatly as this will “induce” “preliminary experience” "
            ...
            Container(
              width: MediaQuery.of(context).size.width * 0.95,
              child: Text("  You are a newcomer and you need some quick cash for encouragement. Well, hold up because there is a bigger fish to fry here. Go slow and steady and you’ll end up with a powerful seller account along with a whole lot of experience. Now you are all ready to leave drop shipping and jump off to FBA. "
            ...
            Container(
              width: MediaQuery.of(context).size.width * 0.95,
              child: Text("  This is as much as I can give you all in a limited scope. This learning can no doubt monetize all of this to full operation extents. Well, the moment you have a team of your own and the team jokes around listing you over Amazon, "
